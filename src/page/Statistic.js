...
import SelectStatisticAction from '../component/action/selectStatisticAction'; 
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        setQuantityProduct(res.data.statistic.map(item => item.totalQuantity));
        ...
        {loading ?
          ...
          <div className='row'>
            <Form className='d-flex justify-content-center' onSubmit={handleSearch}>
              ...
              <Form.Control className='mx-2 w-25' type="date" onChange={(e) => setFrom(e.target.value)} />
              <Form.Label className='mx-2'>To</Form.Label>
              <Form.Control className='mx-2 w-25' type="date" onChange={(e) => setTo(e.target.value)} />
              <Button type='submit' className='mx-2' variant="primary">Search</Button>
            </Form>
            <Form className='d-flex justify-content-center mt-3'>
                <Form.Control as="select" className='mx-2 w-25' defaultValue='' onChange={(e) => handleSelectTop(e.target.value)}>
