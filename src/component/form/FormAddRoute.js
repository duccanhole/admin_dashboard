    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <div className="mt-2 d-flex flex-column justify-content-center">
                <Button className="mx-auto mt-1 w-75" variant="primary" type="submit" disabled={loading}>
                    Submit
                </Button>
                <Button className="mx-auto mt-1 w-75" variant="secondary" onClick={() => props.cancel()}>
                    Cancel
                </Button>
            </div>
        </Form>
