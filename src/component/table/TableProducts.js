...
import { Badge, Table, Button, Dropdown, Modal, Spinner, Form } from "react-bootstrap";
...
export default function TableProduct() {
    ...
    const handleFilter = (e) => {
        ...
        setProducts([...ProductsAction(defaultProducts,'filterByType',valueFilter)]);
        setDialogFilter(false);
    }
    return (
        <>
            ...
            <Modal show={dialogDelete} onHide={() => setDialogDelete(false)} size="md" centered scrollable>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" disabled={disabled} onClick={handleDelete}>Yes</Button>
                </Modal.Footer>
            </Modal>
            {/* Modal EDIT */}
            <Modal show={dialogEdit} onHide={() => setDialogEdit(false)} size="lg" centered scrollable>
                <Modal.Header closeButton>
            ...
            <Modal show={dialogFilter} onHide={() => setDialogFilter(false)} size="md" centered scrollable>
                <Modal.Header closeButton>
                ...
                <Modal.Body className="text-center">
                    <Form onSubmit={handleFilter}>
                        ...
                        <Button variant="primary" type="submit" className="mx-auto mt-3 w-75">
                            Filter
                        </Button>
                    </Form>
                </Modal.Body>
